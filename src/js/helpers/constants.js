...
export const PRODUCTS = [
    ...
    {
        id: 'p1-n',
        title: 'Туалетная Бумага Zewa Плюс 2-ух сл. сирень',
        value: 'p1-n',
        brand: 'zewa',
        type: 'toilet_paper',
    ...
    {
        id: 'p2-n',
        title: 'Туалетная Бумага Zewa Плюс XXL цветы',
        value: 'p2-n',
        brand: 'zewa',
        type: 'toilet_paper',
    ...
    {
        id: 'p3-n',
        title: 'Туалетная Бумага Zewa Ультра Софт 4-х сл.',
        value: 'p3-n',
        brand: 'zewa',
        type: 'toilet_paper',
    ...
    {
        id: 'p4-n',
        title: 'Влажная туалетная бумага Zewa Pure 80 л',
        value: 'p4-n',
        brand: 'zewa',
        type: 'toilet_paper',
        image: '/images/form/products/zewa/p4-n.png',
    },
    {
        id: 'p27',
    ...
    },
    {
        ...
        brand: 'libresse',
        type: 'toilet_paper',
        image: '/images/form/products/lib/p5-n.png',
    },
    {
        id: 'p33',
    ...
    {
        id: 'p39',
        title: 'Впитывающие трусы TENA Lady Slim Pants Normal',
        value: 'p39',
        brand: 'tena',
        type: 'briefs',
